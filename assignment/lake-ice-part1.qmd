...
We expect a negative slope, as when the climate warms over time, we can expect lakes to lose ice earlier in the year. Since earlier dates correspond to smaller day of year values, increasing year should correspond to decreasing ice-off day of year.
...
The slope is negative (-0.1060227), indicating that ice-off dates are occurring earlier over time, which matches our expectation from Question 2.
